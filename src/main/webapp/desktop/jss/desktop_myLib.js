            ...
            $icon.css({
                ...
                "right":function(index,value){
                    if($(this).attr('position')=='right'){
                        var index_=0;
                        var v=window_width*0.24-curcol_right*gW;//(index_-rows*currow_right)*gH;
...
//                myLib.desktop.contextMenu($(document.body),data,"body",10);
    ...
    function initTheme_(){
        ...
        var link = "/awater/desktop/css/blue/homepage.css";//currenTheme   //getAppUrl() +
    ...
    return {
        arrangeIcons:myLib.desktop.deskIcon.arrangeIcons,
        desktopPanel: myLib.desktop.desktopPanel,
        initDeskIcon: myLib.desktop.deskIcon.init,
        initTheme : initTheme_
    }
})