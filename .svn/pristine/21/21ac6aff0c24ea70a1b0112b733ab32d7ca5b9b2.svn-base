package com.augurit.myproject.utils.featureServer;
 ...
 * @author hows
 * */
public final class HttpPostServer {
    private static  Logger logger = Logger.getLogger(HttpPostServer.class.getName());
    ...
    public static String addFeature(String features){
        ...
        try {
            ...
            logger.error("addFeature请求连接或超时异常!");
            return "500";
        }
    }
    public static String updateFeature(String features){
        ...
        try {
            ...
            logger.error("updateFeature请求连接或超时异常!");
            return "500";
        }
        return "300";
    }
    public static Boolean deleteFeature(String ids){
        ...
        try {
            ...
            logger.error("deleteFeature请求连接或超时异常!");
            return false;
        }
    }

    public static Object query(String url,String json,Class clazz){
