...
@Entity
@Table(name = "NW_REPORT_DELETE")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class NwReportDelete implements java.io.Serializable {
	...
	@Id
    @Column(name = "ID")
    @SequenceGenerator(name="SEQ_NW_REPORT_DELETE", sequenceName="SEQ_NW_REPORT_DELETE", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_NW_REPORT_DELETE")
	private Long id;
